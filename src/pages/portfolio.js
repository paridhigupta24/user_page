    ...
    <>
      <div className="wrapper">
        ...
        {prescription.map((item) => {
          return <div>{item.prescriptionText}</div>;
        })}
                ...
                >
                  <div className="portfolio-warp">
                    <div className="portfolio-img">
                      <img
                        src={
                          process.env.PUBLIC_URL + "/assets/img/portfolio-6.jpg"
                        }
                        alt="Team Image"
                      />
                      <div className="portfolio-overlay">
                        <p>
                          Lorem ipsum dolor sit amet elit. Phasel nec pretium
                          mi. Curabit facilis ornare velit non. Aliqu metus
                          tortor, auctor id gravi condime, viverra quis sem.
                        </p>
                      </div>
                    </div>
            ...
            >
              <div className="portfolio-warp">
                <div className="portfolio-img">
                  ...
                  <div className="portfolio-overlay">
                    <p>
                      Another description for Week-2. Replace this with your
                      specific content.
                    </p>
                  </div>
                </div>
            ...
            >
              <div className="portfolio-warp">
                <div className="portfolio-img">
                  ...
                  <div className="portfolio-overlay">
                    <p>
                      Description for Week-4. Customize it based on your
                      specific details.
                    </p>
                  </div>
                </div>
            ...
            >
              <div className="portfolio-warp">
                <div className="portfolio-img">
                  ...
                  <div className="portfolio-overlay">
                    <p>
                      Another description for Week-5. Adjust this content as
                      needed.
                    </p>
                  </div>
                </div>
            ...
            >
              <div className="portfolio-warp">
                <div className="portfolio-img">
                  ...
                  <div className="portfolio-overlay">
                    <p>
                      Description for Week-6. Customize it according to your
                      project.
                    </p>
                  </div>
                </div>
